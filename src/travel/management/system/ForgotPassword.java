...
public class ForgotPassword extends JPanel implements ActionListener{
	...
	p1.setBounds(440, 230, 465, 275);
        p1.setBackground(new Color(173, 216, 244));
        p1.setLayout(null);
	add(p1);
	...
	p1.add(l5);
        ...
        l6.setForeground(new Color(47, 60, 126));
        l6.setBackground(new Color(173, 216, 244));
	add(l6);
	...
	b1.setBackground(new Color(47, 60, 126));
        b1.setForeground(new Color(173, 216, 244));
        p1.add(b1);
	...
	b2.setBackground(new Color(47, 60, 126));
        b2.setForeground(new Color(173, 216, 244));
	p1.add(b2);
	...
	b3.setBounds(150, 230, 100, 25);
        b3.setBackground(new Color(47, 60, 126));
        b3.setForeground(new Color(173, 216, 244));
	p1.add(b3);
