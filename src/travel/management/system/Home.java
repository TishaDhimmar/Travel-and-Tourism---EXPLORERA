...
public class Home extends JFrame implements Runnable, ActionListener{
    ...
    Home() {
        ...
        button = new JPanel();
        button.setBackground(new Color(	47, 60, 126));
        ...
        i4 = new ImageIcon(ClassLoader.getSystemResource("Travel/Management/System/icons/travel.png"));
	...
	button.add(l4);
        ...
        JLabel l5 = new JLabel("EXPLORE ERA");
    ...
    public void activeButton(JButton b){
        ...
        btn.setBackground(new Color(173, 216, 244));
        disable();
    }
    public void disable(){
