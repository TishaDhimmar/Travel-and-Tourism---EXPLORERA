...
public class HomePanel extends JPanel{
	...
	JLabel welcomelabel, l1, l2;
		...
		homeheaderpanel.setBackground(new Color(47, 60, 126));
		...
		homeheaderpanel.add(lblHome);
                ...
                ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Travel/Management/System/icons/homepanel.jpg"));
