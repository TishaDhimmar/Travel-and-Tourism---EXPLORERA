...
public class ProfilePanel extends JPanel implements ActionListener{
	...
	JLabel l1, l2, l3, l4, l5, l6, l7;
		...
		panel1.setLayout(null);
                ...
                panel = new JPanel();
		panel.setBackground(new Color(47, 60, 126));
		...
		panel.add(l1);
		l1.setBackground(new Color(47, 60, 126));
		...
		b1.setForeground(new Color(47, 60, 126));
		...
		b2.setFocusable(false);
                b2.setVisible(false);
		b2.setForeground(new Color(47, 60, 126));
		...
		b3.setFocusable(false);
                b3.setVisible(false);
		b3.setForeground(new Color(47, 60, 126));
